        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              ...
              <Badge className="bg-blue-50 text-blue-700">$0.99 per timestamp</Badge>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              ...
              <Badge className="bg-purple-50 text-purple-700">$1.99 for 10 GIFs</Badge>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              ...
              <Badge className="bg-green-50 text-green-700">$1.99 for 10 thumbnails</Badge>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              ...
              <Badge className="bg-gray-50 text-gray-700">$4.99 for 5 Canvas</Badge>
            </div>
          </div>
